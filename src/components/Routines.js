...
const Routines = ({ routines }) => {
    ...
    return (
        <Card style={{ background: 'black',alignContent:'center' }} elevation={6} >
            <div className='routinesDiv'>
                <form>
                    <Card style={{ padding: '.5rem', margin: '.5rem', background: 'black', width:'100%' }} >
...

                {
                    RoutinesToDisplay.map((routine) => {
                        ...
                        return (
                            <Card key={id} style={{ color: 'white',padding: '0rem', margin: '0rem', background: 'black', width:'100%', display:'block'}}>
                            <div className='routine' key={id}>
                                ...
                                <Link style={{ textDecoration: 'none' }} to={`/routines/${creatorName}`}><Button
                                                        style={{
                                                            height: '4rem',
                                                            margin: '.5rem', width: '96%', borderRadius: 15, backgroundColor: 'black',
                                                        }}
                                                        variant='contained'
                                ...
                                <ul>
                                    
                                    {
                                        activities.map((activity) => {
                                            ...
                                            return (
                                                <Card key={id} style={{ padding: '1rem', margin: '.5rem', background: 'black',width:'100%',textSizeAdjust:'auto' }}>
                                                <li key={id}>
                                                    <Link style={{
                                                        textDecoration: 'none'
                                                    }}
                                                        ...
                                                        style={{
                                                            height: '2rem',
                                                            margin: '.5rem', width: '94%', borderRadius: 15, backgroundColor: ' black', fontSize: '13pt'
                                                        }}
                                                        variant='contained'
